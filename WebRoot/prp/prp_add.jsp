...
<html>
  ...
  <body>
     <div class="prp_add">
    	<div class="p_header"><span class="p_title">增加新PRP阶段(红色必填)</span></div>
    	<div class="p_form">
    		<table border="1" cellspacing="0" cellpadding="0" bordercolor="#fff" align="center" style="width:100%">
    			...
    			<tr align="center"><td>备注</td><td colspan="3"><textarea rows="2" cols="140%" id="other"></textarea></td></tr>
    			<tr align="right"><td colspan="4"><input type="button" value="提交" onclick="addPrp()"/> <input type="button" value="重置" onclick="reset()"/> <input type="button" value="返回" onclick="toPRPMain()"/></td></tr>
    		</table>
    	</div>
    </div>
    <script type="text/javascript">
    	function toPRPMain(){
			window.location.href="servlet/PrpGetAllByPageServlet";
    	}
    	function reset(){
    	...
    	function addPrp(){
			...
			xmlHttp.open("POST", "servlet/PrpAddServlet", true);
