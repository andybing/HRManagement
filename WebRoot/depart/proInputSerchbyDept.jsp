...
<html>
  ...
  <table border="1" cellspacing="0" align="center" bgcolor="#A7EFF5" width="900px">
    <tr><th colspan="6"><font size="12px"> 项目工作量查询-按部门查询</font></th></tr>
    <tr><td>开始日期</td><td>
...
<td>项目
 ...
 <div class="iframe">
 	<iframe width="910px" scrolling="no" style="padding:0px;" height="500px" frameborder="0" src="depart/proInputSerchbyDeptShow.jsp"></iframe>
 </div>
  </body>
</html>
