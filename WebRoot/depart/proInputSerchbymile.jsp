...
<html>
  <head>
    ...
    <title>My JSP 'proInputSerch.jsp' starting page</title>
  ...
  <table border="1" cellspacing="0" align="center" bgcolor="#A7EFF5" width="900px">
    <tr><th colspan="7"><font size="12px"> 项目投入查询-按里程碑</font></th></tr>
    <tr>
    <td>项目
...
<input type = "button" value = "查询"/><input type = "button" value = "重叠"/></td></tr>
 </table><br/>
<div class="iframe">
 	<iframe width="910px" scrolling="no" style="padding:0px;" height="500px" frameborder="0" src="depart/proInputSerchbymileShow.jsp"></iframe>
 </div>
  </body>
</html>
