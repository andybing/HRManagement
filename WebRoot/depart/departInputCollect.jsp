...
<html>
  <head>
    ...
    <title>My JSP 'departInputCollect.jsp' starting page</title>
...
<style type="text/css">
  ...
  <table border="1" cellspacing="0" align="center" bgcolor="#A7EFF5" width="900px">
    <tr><th colspan="6"><font size="12px">部门工作量查询-部门投入汇总</font></th></tr>
    <tr><td>开始</td><td>
...
<td>部门
 ...
 <div  class="iframe">
 <iframe width="910px" scrolling="no" style="padding:0px;" height="400px" frameborder="0" src="depart/departInputCollectShow.jsp"></iframe>
 </div>
  </body>
</html>
