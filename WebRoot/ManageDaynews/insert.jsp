 ...
 var miaoshu=document.getElementById("miaoshu").value;
  ...
  return;
	...
	<style type="text/css">
		...
		.prp_query .p_form{width:100%;height:170px;background:#eaeaea;}
		.right{float:right;}
	</style>
  </head>
  ...
  <body>
    <div class="prp_query">
    	<div class="p_header"><span class="p_title">日报管理-添加条件</span></div>
    	<div class="p_form">
    		<table border="1" cellspacing="1" cellpadding="1" bordercolor="#fff" align="center"  style="width:100%">
    			...
    			<td align="left" colspan="3"><textarea rows="3" cols="10" style="width:90%;"  id="miaoshu" onclick="select1()"></textarea><br/></td>
    			</tr>
    			...
    			<tr align="right">
    			 <td colspan="4">
    			 	<input type="button" align="right" value="提交" onclick="return2()">
